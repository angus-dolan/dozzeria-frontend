<template>
  <div class="border-b bg-white dark:bg-ui-dark-400 border-gray-200 dark:border-ui-dark-500">
    <div class="container px-4 mx-auto flex justify-between flex-wrap content-center" style="height: 90px">
      <!-- app logo -->
      <img v-if="theme == 'light'" src="@/assets/svg/logo-light.svg" alt="Dozzeria Logo Light">
      <img v-else src="@/assets/svg/logo-dark.svg" alt="Dozzeria Logo Dark">

      <!-- color mode toggle -->
      <button @click="toggleTheme" class="p-4 pr-0">
        <!-- heroicons:sun -->
